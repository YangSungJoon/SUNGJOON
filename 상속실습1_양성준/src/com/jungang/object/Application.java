...
public class Application {
	...
	public static void main(String[] args) {
		...
		System.out.println(product1.getName()+" "+product1.getId()+" "+product1.getSite()+" "+product1.getPrice()+" "+product1.getTax());
		System.out.println(product1.information());
		System.out.println(product2.information());
		System.out.println(product3.information());
		System.out.println("==========================================================");
		
		product1.setPrice(1200000);product1.setTax(0.05);
		product2.setPrice(1200000);product2.setTax(0.05);
		product3.setPrice(1200000);product3.setTax(0.05);
